...
const Pwd: React.FC<PwdProps> = ({
  ...
  <div className="space-y-3 border-t border-white/50 pt-2">
    ...
    <form
      ...
      onSubmit={(e) => {
        e.preventDefault()
        if (!changing && currentPassword && newPassword) onChangePassword()
      }}
    >
      <input
        type="text"
      ...
      <div className="flex items-center justify-between">
        ...
        <input
          ...
          className="w-40 rounded-md border border-gray-300 px-3 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
          placeholder="当前管理员密码"
        />
      </div>
