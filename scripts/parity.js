...
const ROUTE_MAP = {
  ...
  'api/share.js': 'server/routes/share.js',
  'api/share/[token].js': 'server/routes/share.js',
  'api/notes/[id]/shares.js': 'server/routes/share.js',
  ...
  'api/settings/[key].js': 'server/routes/settings.js',
  'api/cron/logs.js': 'server/context.js',
  'api/ai/status.js': 'server/routes/ai.js',
  'api/ai/complete.js': 'server/routes/ai.js',
}

const CF_MAP = {
  'functions/api/login.ts': 'api/login.js',
  'functions/api/share.ts': 'api/share.js',
  'functions/api/share/[token].ts': 'api/share/[token].js',
  'functions/api/notes/[id]/shares.ts': 'api/notes/[id]/shares.js',
  ...
  'functions/api/settings/[key].ts': 'api/settings/[key].js',
  'functions/api/ai/status.ts': 'api/ai/status.js',
  'functions/api/ai/complete.ts': 'api/ai/complete.js',
  'functions/api/cron/logs.ts': 'api/cron/logs.js',
}

const EDGE_MAP = {
  'edge-functions/api/login.js': 'api/login.js',
  'edge-functions/api/share.js': 'api/share.js',
  'edge-functions/api/share/[token].js': 'api/share/[token].js',
  'edge-functions/api/notes/[id]/shares.js': 'api/notes/[id]/shares.js',
  ...
  'edge-functions/api/settings/[key].js': 'api/settings/[key].js',
  'edge-functions/api/ai/status.js': 'api/ai/status.js',
  'edge-functions/api/ai/complete.js': 'api/ai/complete.js',
  'edge-functions/api/cron/logs.js': 'api/cron/logs.js',
}
