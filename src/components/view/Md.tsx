...
import { highlightRangeInContent, isExternalUrl, type HighlightRange } from '@/lib/mdView'
...
const Md: React.FC<MdProps> = ({
  ...
  const displayContent = useMemo(() => (content ? preserveExtraBlankLines(content) : ''), [content])
  ...
  const components = useMemo(
    () => ({
      ...
      pre: ({ children }: { children?: React.ReactNode }) => <CodePre>{children}</CodePre>,
