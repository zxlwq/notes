...
export function copyTextToast(message: string) {
  const successMessage = document.createElement('div')
  successMessage.textContent = message
  successMessage.className =
    'fixed top-1/2 left-1/2 z-[11000] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-lg bg-green-500 px-6 py-3 text-center text-white shadow-lg'
